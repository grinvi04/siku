...
밥 같이 먹는 사이, 식구. 모임의 기록·사진·정산을 한 곳에서 — 설치 없이 웹으로.
...
[AGENTS.md](AGENTS.md) (작업 규약) · [DESIGN.md](DESIGN.md) (디자인 시스템) · [CLAUDE.md](CLAUDE.md) (Claude Code 지침) · `supabase/migrations/` (DB)
